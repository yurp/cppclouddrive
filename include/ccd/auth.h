...
public:
    ...
    oauth2(ccd::http::transport_factory f,
           std::string app_id,
...
private:
    ccd::http::transport_factory m_f;
    std::string m_app_id;
...
{
public:
    oauth2_gdrive(ccd::http::transport_factory f, std::string app_id, std::string app_secret);
...
{
public:
    oauth2_dropbox(ccd::http::transport_factory f, std::string app_id, std::string app_secret);
