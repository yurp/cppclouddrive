...
public:
    ...
    copy& set_allow_shared_folder(bool x);
    ...
    copy& set_allow_ownership_transfer(bool x);
...
private:
    ...
    ///                      the destination.
    copy(ccd::http::transport_func http_transport, std::string from_path, std::string to_path);
